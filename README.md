...
### 1.Mémoire secondaire MS :
    ...
    - **Function "InitializeDisk"** : Nbr total de blocs + Facteur de blockage (all blocks are free in start) ;
    - **Function "Metajour"** : Mise à jour d'état des blocks aprés chaque opération ;
